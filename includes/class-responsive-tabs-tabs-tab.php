  	...
  	public function tab_settings_info()	{
    	...
    	_e( 	'<p>For the content, you have the following options:</p>
    		  	...
    		  	<ol>
    		  		...
    		  		<li><em>any</em> widget -- option 2 above display widget areas, populated through Appearance>Widgets.  If you wish you can directly name a widget.  See wordpress documentation of <a href="http://codex.wordpress.org/Function_Reference/the_widget"  target = "_blank">standard widget classes.</a>
    		  	</ol>'   , 'responsive-tabs');
